...
<p align="center">
  Hola, soy un <strong>Ingeniero en Software</strong> enfocado en la creación de soluciones completas y fácilmente escalables, 
  aplicando buenas prácticas de programación con los principios <strong>Clean Code</strong> y <strong>SOLID</strong>.<br><br>
  Me apasiona el mundo de la tecnología y los <strong>Fighting Games 🎮</strong>.
</p>
